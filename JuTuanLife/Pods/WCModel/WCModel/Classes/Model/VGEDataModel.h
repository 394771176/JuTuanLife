...
@property (nonatomic, strong, readonly) WCDataResult *result;
...
- (id)parseData:(id)data;  //loaded only at success (WCDataResult is YES)
- (id)defaultData;         //loaded only at failed  (WCDataResult is NO)
