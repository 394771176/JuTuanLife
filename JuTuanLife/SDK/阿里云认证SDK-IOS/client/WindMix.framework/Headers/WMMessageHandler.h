...
// 设置全屏接口
- (void)setFullScreen:(BOOL)fullScreen shouldRotate:(BOOL)shouldRotate viewId:(NSString*)viewId;

// 调用方法
- (void)callMethod:(NSString*)methodName
            viewId:(NSString*)viewId
              data:(NSDictionary*)data
          callback:(RVTComponentCallback)callback;

// 合并数据
- (NSDictionary*)mergeDic:(NSDictionary*)orignDic newDic:(NSDictionary*)newDict;
