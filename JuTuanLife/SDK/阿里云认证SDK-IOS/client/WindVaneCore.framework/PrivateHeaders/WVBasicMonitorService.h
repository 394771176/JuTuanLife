...
/**
 表示 WebView 统计监控信息。
 */
@interface WVWebViewStatisticsMonitorInfo : NSObject <WMLMonitorStatProtocol>
 ...
 */
@interface WVWebViewStartMonitorStat : NSObject <WMLMonitorStatProtocol>
...
/**
 表示 POST 请求的监控信息。
 */
@interface WVPostRequestInfo : NSObject <WMLMonitorStatProtocol>
 ...
 * 表示状态码的性能监控信息。
 */
@interface WVStatusCodeStat : NSObject <WMLMonitorStatProtocol>
 ...
 */
@interface WVJavaScriptErrorStat : NSObject <WMLMonitorStatProtocol>
 ...
 * 表示首屏时间的埋点信息。
 */
@interface WVFirstScreenPaintTimeStat : NSObject <WMLMonitorStatProtocol>

/**
 * [维度]当前 WKWebView 加载的 URL。
 */
@property (nonatomic, copy, readonly, nonnull) NSString * url;
...
/**
 * 使用 “当前 WKWebView 加载的 URL“ 和首屏时间初始化。
 */
- (instancetype _Nonnull)initWithURL:(NSString * _Nonnull)url withTime:(UInt64)time;
...
/**
 报告 WVWebView 的使用方。
 */
- (void)reportWVWebViewUser:(NSString * _Nonnull)user;
