...
#import <WindVaneCore/WVPageTracker.h>
#import <WindVaneCore/WVResourceTracker.h>
#import "WVWebViewPerfRecorder.h"
 ...
 * 使用指定的 WebView 初始化。
 */
- (instancetype)initWithWebView:(UIView<WVWebViewProtocol> *)webview webViewIdentifier:(NSString *)identifier;
 ...
 * 关联的自定义内容控制器。
 */
@property (nonatomic, strong, readonly) WVUserContentController * userContentController;

/**
 * WebView 的性能记录器。
 */
@property (nonatomic, strong) WVWebViewPerfRecorder * perfRecorder;

/**
 * 页面追踪器。
 */
@property (nonatomic, strong) WVPageTracker * pageTracker;

/**
 * 资源追踪器。
 */
@property (nonatomic, strong) WVResourceTracker * resourceTracker;

/**
 * JSBridge 上下文。
 */
@property (nonatomic, strong, readonly) WMBridge * jsBridgeContext;
