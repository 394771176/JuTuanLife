 ...
 * 首屏时间的管理器。
 */
@property (nonatomic, strong) WVFSPManager * fspManager;

/**
 * 白屏时间的管理器。
 */
@property (nonatomic, strong) WVFPManager * fpManager;
 ...
 * Triver 的性能代理。
 */
@property (nonatomic, weak) id<WVPerformanceProtocol> performanceDelegate;
