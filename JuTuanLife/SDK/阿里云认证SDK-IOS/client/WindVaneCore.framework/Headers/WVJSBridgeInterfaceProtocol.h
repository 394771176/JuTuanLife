...
/*************************************************************************************
 * 请移步 <WindmillBridge/WMBridgeProtocol.h>
 * 这里的用法是准备废弃的，请总是使用 WMBridgeHandler
*************************************************************************************/
 ...
 */
typedef WMBridgeScope WVJSBridgeScope;
enum {
	WVJSBridgeScopeInvocation = WMBridgeScopeInvocation,
	WVJSBridgeScopePage = WMBridgeScopePage,
	WVJSBridgeScopeWebView = WMBridgeScopeView,
	WVJSBridgeScopeStatic = WMBridgeScopeStatic,
};
typedef WMBridgeCallback WVJSBResponse;
