...
/**
 资源的缓存状态。
 */
typedef NS_OPTIONS(NSInteger, WVCacheState) {
	WVCacheStateNoZCache,     // 未使用 ZCache
	WVCacheStateZCacheNotHit, // 使用了 ZCache，但是未命中
	WVCacheStateZCacheHit     // 使用了 ZCache，并命中了
};
 ...
 * 缓存状态。
 */
@property (nonatomic, assign, readonly) WVCacheState cacheState;
