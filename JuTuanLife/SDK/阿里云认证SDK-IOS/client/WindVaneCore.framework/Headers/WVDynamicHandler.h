...
/**
 ...
 [STEP 1] 令你要输出为服务的类集成 WVDynamicHandler（引入头文件 <WindVane/WindVane.h>）。
...
/**
 动态 WVBridge 的基类。
 */
@interface WVDynamicHandler : NSObject <WVBridgeProtocol, WMBridgeProtocol>

/**
 WVBridge 的上下文。
 */
@property (nonatomic, weak) id<WMBridgeContext> context;
